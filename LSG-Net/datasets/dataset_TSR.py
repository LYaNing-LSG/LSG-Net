...
class ContinuousEdgeLineDatasetMask(Dataset):
    ...
    def __init__(self, pt_dataset,edge_path=None, irregular_mask_path=None, coco_mask_path=None, test_mask_path=None, is_train=False, mask_rates=None,
    ...
    def __getitem__(self, idx):
        ...
        edge = self.load_edge(img_gray,idx)
        edge = rgb2gray(edge)
...
class ContinuousEdgeLineDatasetMaskFinetune(ContinuousEdgeLineDatasetMask):
    ...
    def __init__(self, pt_dataset, edge_path=None,irregular_mask_path=None, coco_mask_path=None, test_mask_path=None,
                 is_train=False, mask_rates=None, image_size=256, line_path=None):
        super().__init__(pt_dataset,edge_path, irregular_mask_path, coco_mask_path, test_mask_path, is_train, mask_rates, image_size, line_path)
