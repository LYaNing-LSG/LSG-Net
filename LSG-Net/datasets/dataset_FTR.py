...
class ImgDataset(torch.utils.data.Dataset):
    def __init__(self, flist, input_size, mask_rates=None,irregular_mask_path=None, coco_mask_path=None,augment=True, training=True, test_mask_path=None):
        ...
        if training:
            ...
            with open(irregular_mask_path) as f:
                for line in f:
...
class DynamicDataset(torch.utils.data.Dataset):
    def __init__(self, flist, batch_size,edge_path=None,
                 irregular_mask_path=None, coco_mask_path=None,  add_pos=False, pos_num=128,
        ...
        self.round = round  # for places2 round is 3
        
        self.data = []
        self.edge_data = self.load_flist(edge_path)
        if load_path:
