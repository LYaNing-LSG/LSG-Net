...
class LaMa_model(nn.Module):
    def __init__(self):
        ...
        self.block1 = Block(dim = ch*8,order=5)
        self.block2 = Block(dim = ch*8,order=6)
        self.block3 = Block(dim = ch*8,order=5)
        self.block4 = Block(dim = ch*8,order=6)
        self.block5 = Block(dim = ch*8,order=5)
    ...
    def forward(self, x, mask,rel_pos_emb=None, direct_emb=None, str_feats=None):
        x = self.pad1(x)
        x = self.conv1(x)
